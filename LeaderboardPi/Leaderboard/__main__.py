...
def main():
    ...
    while True:
        ibutton1 = str(input("Member 1: "))  # read_button()
        ibutton2 = str(input("Member 2: "))  # read_button()
        member1 = instance.get_member(ibutton1, uid=True)
        print(member1)
        member2 = instance.get_member(ibutton2, uid=True)
        print(member2)
